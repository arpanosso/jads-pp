...
df <- da_pad_gp %>% 
  ...
  select(pbf_familias,areapper,areapltem,pvalorpper,pvalortem,pnae_vte,snutrip,
         slacp,cri04pxi_mb,cri04pxi_a,
         adolaxi_b,adolaxi_a,adulimc_b,adulimc_a,adulimc_obesg_i,adulimc_obesg_ii,
         adol_ultra,adul_ultra,cri59_ultra,ido_ultra) %>%  # idimc_b,idimc_a,idimc_sob
  drop_na()
visdat::vis_miss(df)
```
```{r}
...
corrplot(cor_matrix, type = "upper", method="ellipse")
```
